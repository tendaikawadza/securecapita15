...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static final String[] PUBLIC_ROUTES = {"/user/login", "/user/verify/code", "/user/register","/user/list", "/purchaseRequisition/upload","stock/**", "/user/refresh/token", "/user/image"};
